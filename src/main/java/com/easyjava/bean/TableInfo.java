...
public class TableInfo {
    ...
    public String getBeamParamName() {
        return beamParamName;
    }

    public void setBeamParamName(String beamParamName) {
        this.beamParamName = beamParamName;
    }
